...
TYPE1="--synthetic-csv $ROOT/results/paper_aligned_type1_negatives/regio_hitea_type1_negatives.csv"
start_run() {
  name=$1
  gpu=$2
  extra=$3
...
start_run paper_aligned_type1_h4096_n2048_e80 4 "--hidden-dim 4096 --n-bits 2048"
start_run paper_aligned_type1_h2048_n4096_e80 1 "--hidden-dim 2048 --n-bits 4096"
