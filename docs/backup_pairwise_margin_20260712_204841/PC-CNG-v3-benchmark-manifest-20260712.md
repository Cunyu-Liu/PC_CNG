...
| PC-CNG diverse-anchor reviewed | Boundary negatives | `results/type1_diverse_anchor_full/diverse_anchor_candidates_reviewed.csv` | Synthetic train only via parent source split | Pairwise training and reranking candidates |
