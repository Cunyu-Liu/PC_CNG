...
最强主结论应放在：
## 2026-07-12 增量审计：Combined 特征 + Hidden-dim Scale-up

本节补充 2026-07-12 完成的 combined 特征架构消融和 hidden_dim=4096 scale-up 实验。
...
| Scale-up: hidden_dim 2048→4096 (in progress) | `results/type1_v2_hidden4096_20260712/` | Seed 1: test Top-1 87.65% vs v2 86.42%, +1.23 pp | Early signal positive; 10-seed pending (est. 2-3h) |
...
Hidden-dim 4096 scale-up shows early positive signal (+1.23 pp on seed 1);
full 10-seed result pending.
```
